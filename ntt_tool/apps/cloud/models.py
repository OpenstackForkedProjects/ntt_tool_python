...
class UDPTestResults(models.Model):
    ...
    jitter_units = models.CharField(max_length=5, default='ms')
    bandwidth = models.FloatField()
    bandwidth_loss = models.FloatField()
    bandwidth_units = models.CharField(max_length=5, default='bits')
    interval_time_start = models.FloatField()
    interval_time_end = models.FloatField()
    interval_time_units = models.CharField(max_length=5, default='sec')
    bytes_transferred = models.IntegerField()
    bytes_transferred_units = models.CharField(max_length=5, default='bits')
    datagrams = models.IntegerField()
    loss_datagrams = models.IntegerField()
    cpu_utilization_src = models.FloatField()
    cpu_utilization_dest = models.FloatField()
...
class TCPTestResults(models.Model):
    ...
    dest_ep = models.TextField()
    status = models.CharField(max_length=20)
    retransmits = models.IntegerField()
    bandwidth = models.FloatField()
    bandwidth_units = models.CharField(max_length=5, default='bits')
    interval_time_start = models.FloatField()
    interval_time_end = models.FloatField()
